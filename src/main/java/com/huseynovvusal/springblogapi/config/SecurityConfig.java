...
/**
 * Security configuration class for setting up Spring Security. Configures JWT authentication,
 * stateless session management, and endpoint access rules.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
  ...
  /**
   * Configures the security filter chain for HTTP requests. - Disables CSRF - Permits
   * unauthenticated access to /auth/** endpoints - Requires authentication for all other endpoints
  ...
  @Bean
  public FilterRegistrationBean<JwtAuthenticationFilter> disableJwtServletFilter(
  ...
  @Bean
  public FilterRegistrationBean<BlockedUserFilter> disableBlockedUserServletFilter(
  ...
  @Bean
  public FilterRegistrationBean<DatabaseHealthFilter> disableDatabaseHealthServletFilter(
      DatabaseHealthFilter filter) {
    FilterRegistrationBean<DatabaseHealthFilter> registration =
        new FilterRegistrationBean<>(filter);
    registration.setEnabled(false);
    return registration;
  }
