...
/**
 * Filter that intercepts incoming HTTP requests to validate JWT tokens. If a valid token is found,
 * it sets the authentication context for the current user.
 */
@Slf4j
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  /**
   * Extracts and validates JWT from the Authorization header. If valid, sets the authentication
