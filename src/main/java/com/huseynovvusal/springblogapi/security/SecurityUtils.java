...
/**
 * Utility class for accessing security-related information from the current context. Provides
 * methods to retrieve the authenticated user's ID and username.
 */
@Slf4j
